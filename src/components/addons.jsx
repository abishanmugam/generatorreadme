  ...
  <>
    ...
    <span className="mt-2 flex items-center">
      ...
      {isGitHubUsernameValid(githubName) ? (
        <img
          src={`https://komarev.com/ghpvc/?username=${githubName}&label=${encodeURI(
            badgeOptions.badgeLabel
          )}&color=${badgeOptions.badgeColor}&style=${badgeOptions.badgeStyle}`}
  ...
  <>
    ...
    <label htmlFor={`${prefix}-title-color`}>
      ...
      <input
        ...
        className="w-6"
        onChange={(e) =>
          onUpdate('titleColor', e.target.value.replace('#', ''))
        }
      />
    </label>
